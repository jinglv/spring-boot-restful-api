        ...
        stage('SonarQube代码质量扫描') {
            steps {
                sh '''
                    ...
                    cd ${WORKSPACE}
                    mvn sonar:sonar -Dsonar.projectKey=spring-boot-restful-api -Dsonar.host.url=http://8.140.112.109:9000/ -Dsonar.login=ccfc60220c447803b94b827ea6a16ae245399ef1
                '''
            }
        }
